...
urlpatterns = [
        ...
        path('add_event_owner',views.add_event_owner,name="add_event_owner"),

        path('userhome', views.userhome, name="userhome"),
        path('add_event', views.add_event, name="add_event"),
        path('view_event', views.view_event, name="view_event"),
        path('view_event_owner',views.view_event_owner,name="view_event_owner"),
        path('delete_event(?p<int:pid>)', views.delete_event, name="delete_event"),
        path('delete_event_owner(?p<int:pid>)', views.delete_event_owner, name="delete_event_owner"),
        ...
        path('booking_request_owner', views.booking_request_owner, name="booking_request_owner"),
        ...
        path('edit_event_owner/<int:pid>', views.edit_event_owner, name="edit_event_owner"),
